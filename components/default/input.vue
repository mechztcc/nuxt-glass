<template>
  ...
  <div class="flex items-center border px-5 w-full border-zinc-300 dark:bg-zinc-900 bg-white rounded">
    ...
    <Field :name="field" v-model="inputValue" :placeholder="placeholder" :type="type" :validate-on-change="true" :keep-value="true" class="p-3 outline-none w-full bg-zinc-50 dark:bg-zinc-900 dark:text-zinc-50" />
