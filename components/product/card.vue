<template>
  <div class="grid grid-cols-2 md:col-span-2 mb-5 gap-2 dark:text-zinc-50 dark:bg-zinc-900 dark:rounded-xl">
    <div :class="['col-span-2 md:col-span1']">
      ...
      <div class="flex flex-col justify-between h-full py-3 px-2">
        ...
        <div class="flex mt-2 mb-3">
          <div class="flex flex-col items-center">
            ...
            <font-awesome-icon :icon="['fas', 'square']" :class="color" />
          </div>
          <div class="flex flex-col items-center mx-3">
            <span class="font-semibold">Estoque</span>
            <span>{{ product.productValues?.amount ?? '0' }}</span>
          </div>
          <div class="flex flex-col items-center mx-3">
        ...
        <div class="col-span-1 text-start">
          <div class="flex">
            ...
            <div class="flex flex-col items-center mx-3">
              ...
              <span>{{ product.glassType }}</span>
            </div>
          </div>
        </div>
        <DefaultButton :label="'Editar'" :fill="true" />
      </div>
    </div>
  </div>
</template>
